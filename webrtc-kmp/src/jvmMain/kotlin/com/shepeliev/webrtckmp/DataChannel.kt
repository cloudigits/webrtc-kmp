...
public actual class DataChannel(public val native: NativeDataChannel) {
    ...
    public actual val onMessage: Flow<ByteArray> = dataChannelEvent
    ...
    public actual fun close(): Unit = native.dispose()
