...
public actual class RtcCertificatePem internal constructor(public val native: NativeRtcCertificatePem) {
    public actual val privateKey: String
        get() = native.privateKey

    public actual val certificate: String
    ...
    public actual companion object {
        ...
        public actual suspend fun generateCertificate(keyType: KeyType, expires: Long): RtcCertificatePem {
